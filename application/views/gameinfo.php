                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12" style="color:red">
                                                        ...
                                                        <div class="jindutiao col-md-4 col-sm-4 col-xs-4">
                                                            <div style=" width:<?php echo $giftsnum["count(gameid)"]/$val['giftsnum']*100?>%; background: red; height:5px;  float:left;"> &nbsp;</div>
                                                        </div>
                                                        <small  class="col-md-3 col-sm-3 col-xs-3"  style="width:auto;"><?php echo $giftsnum["count(gameid)"]?>个</small>
                                                    </div>
                                                </div>
