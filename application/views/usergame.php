...
<div class="col-md-6 col-sm-6 col-xs-6"  style=" margin-left:-10px;">
	<div class="row">
        ...
        <div class="col-md-3 col-sm-3 col-xs-3" style=" float:left; margin-left:-20px;"><a href="gifts"><button type="button" class="btn btn-default btn-xs disabled" style="color:#0CF; border:2px solid #0CF">礼包 X <?php echo $giftsnum['num']?></button> </a>       </div>
    </div>
    <div class="row">
