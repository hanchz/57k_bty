...
<form action="spwd"  name="form" method="post" id="form">
    ...
    <span class="glyphicon glyphicon-user" style="color:#000; margin-top:10px;"></span>
    </div>
    <div class="col-md-10 col-sm-10 col-xs-10" >
    <input type="text" class="form-control input-group-sm zj_input" style="color: black;" id="username" name="username" placeholder="输入用户名">
    </div>
    </li>
...
<div class="row" style="margin-top: 30px;">
 <div class="col-md-1 col-sm-1 col-xs-1"></div>
  <div class="col-md-10 col-sm-10 col-xs-10"><a class="btn btn-danger zj_btn" style=" width:100%; background:red; margin-left:0px; margin-top: 20px; color: #FFF;" onClick="fpwd()" role="button">下一步</a></div>
