...
<form id='frmSubmit' method='post' name='frmSubmit' action='<?php echo $PAY_URL?>'>
    ...
    <input type='text' name='agent_bill_id' value='<?php echo $agent_bill_id;?>' />
    <input type='text' name='agent_bill_time' value='<?php echo  $agent_bill_time;?>' />
    <input type='text' name='pay_type' value='<?php echo $pay_type;?>' />
    <input type='text' name='pay_code' value='<?php echo $pay_code;?>' />
    <input type='text' name='pay_amt' value='<?php echo $pay_amt;?>' />
    <input type='text' name='notify_url' value='<?php echo $notify_url;?>' />
    <input type='text' name='return_url' value='<?php echo $return_url;?>' />
    <input type='text' name='user_ip' value='<?php echo $user_ip;?>' />
    <input type='text' name='goods_name' value='<?php echo urlencode($goods_name);?>' />
    <input type='text' name='goods_num' value='<?php echo  urlencode($goods_num);?>' />
    <input type='text' name='goods_note' value='<?php echo urlencode($goods_note);?>' />
    <input type='text' name='remark' value='<?php echo urlencode($remark);?>' />
    <input type='text' name='is_phone' value='<?php echo $is_phone;?>' />
    <input type='text' name='is_frame' value='<?php echo $is_frame;?>' />
