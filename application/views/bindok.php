...
<div class="col-md-6 col-sm-6 col-xs-6">
	...
	您已成功绑定<?php echo $_GET['tel']?>
		</div>
	</div>

 <div class="col-md-1 col-sm-1 col-xs-1"></div>
  <div class="col-md-10 col-sm-10 col-xs-10" style="margin-top: 20%;"><a class="btn btn-danger zj_btn" style=" width:100%; background:red; margin-left:0px; margin-top: 20px; color: #FFF;"  role="button" href="user">完成</a></div>
