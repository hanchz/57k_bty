        ...
        <div class="col-md-8 col-sm-8 col-xs-8">
            <form action="sou" method="get">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="name" name="gamename" placeholder="三生三世" style="background:#e8e8e8; border-bottom-right-radius:75px; border-top-right-radius:75px" value="三生三世">
