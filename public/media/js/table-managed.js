    ...
    return {
        ...
        init: function () {
            ...
            $('#sample_1').dataTable({
                ...
                "sAjaxSource": '/admin.php/games/get_list',
                "aaSorting": [
                    [0, "desc"],
                ],
                "aoColumns": [
                    ...
                    {"mData": "id", "bSortable": true, "mRender": function(data, type, full) {
                        return "<a href='/admin.php/games/edit/"+data+"' >修改</a>|<a href='/admin.php/games/gift_list/"+data+"' >礼包</a>|<a href='/admin.php/news/news_list/"+data+"' >新闻</a>";
                    }}
